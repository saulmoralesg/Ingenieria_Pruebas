...
<div align="center" style="background-color:#FFF; border:0; color:#000; font-size:14px; font-weight:bold;">  
  <table width="480" border="0" id="customers"> 
    <tr>
      ...
      <td width="404"><div align="left">La Delegaci&oacute;n/UMAE  ha finalizado el registro de informaci&oacute;n.</div></td>
    </tr>
    
    <tr>
      <td ><img src="Imagenes/rojo.png" width="25" height="25"></td>
      <td ><div align="left">La Delegaci&oacute;n/UMAE a&uacute;n no finaliza el registro de informaci&oacute;n. </div></td>
    </tr>
  </table>
  <br>
...
<div align="center" style="background-color:#FFF; border:0; color:#000; font-size:14px; font-weight:bold">  
	<br>
  Paso 1.- Seleccionar la Delegación/UMAE a la que pertenece,<br>haciendo clic izquierdo sobre el nombre de la misma.</div>
<div>
    ...
    <form name="form1" method="POST">
        <thead>
          <tr>
            ...
            <th rowspan="2" ><div align="center">Delegaci&oacute;n/UMAE</div></th>
...
LEFT JOIN requerimiento_issste_2022  b ON a.clp2=b.clp
...
?>		<tbody>
		...
		<input type="text" id="<?php echo "delegoumae".$i;?>" name="<?php echo "delegoumae".$i;?>" value="<?php echo $delegoumae;?>" style="display:none">
            ...
            <td align="Right"><?php if($status=='del_conexcedenteofaltante') echo $excedenteofaltante; else if($status=='del_sinnecesidad') echo 0;?></td>
