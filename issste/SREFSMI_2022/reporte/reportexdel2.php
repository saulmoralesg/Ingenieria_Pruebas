...
$query=mysql_query("SELECT del, delegoumae FROM cat_clues_issste_2022  WHERE del='$del'");
...
FROM
	cat_clues_issste_2022  a LEFT JOIN requerimiento_issste_2022  b ON a.clp=b.clp
WHERE
...
SELECT
	...
	pacientes
	FROM
requerimiento_issste_2022  a LEFT JOIN cat_clues_issste_2022  b ON a.clp=b.clp2
WHERE
	b.del = '$del' AND
	excedentea>0
GROUP BY
