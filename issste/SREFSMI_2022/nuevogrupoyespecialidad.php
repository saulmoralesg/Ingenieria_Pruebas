...
<td><a href="Manual/Guia_ayuda_2021_issste_2022_2022.pdf"><img src="Imagenes/guia.jpg" border="0" width="37" alt="Guía de Ayuda"/></a><br><strong><label onClick="window.location.href=''">Guía de Ayuda</label></strong></td>
...
?>			
	...
	<span onClick="xyz2(<?php echo $i;?>,<?php echo $i;?>)"><?php echo $ids[$i];?></span>
	</div></td>            	
	<td><div align="center">		
