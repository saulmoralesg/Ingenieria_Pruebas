...
error_reporting(0);
$pdf=$del.$file_name;
$query=mysql_query("SELECT * FROM pdf WHERE del='$del'");

if(mysql_num_rows($query)>0)
mysql_query("DELETE FROM pdf WHERE del='$del'");
mysql_query("INSERT INTO pdf (del, delegoumae,pdf,fecsis,ipconfig) VALUES ('$del','$delegoumae','$pdf','$fecsis','$ipconfig')");
