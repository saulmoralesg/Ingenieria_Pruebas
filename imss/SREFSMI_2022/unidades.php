	...
	<input type="text" id="delegoumae" name="delegoumae" value="<?php echo $delegoumae;?>" style="display:none">
        <tbody>
          ...
          <tr>
            ...
            <th width="264" ><div align="center">Unidad M&eacute;dica</div></th>
            <th><div align="center">&iquest;Con excedentes/<br>
            faltantes? </div></th>
...
FROM
cat_clues a LEFT JOIN requerimiento b ON a.clp2=b.clp
WHERE
a.del='$del'
GROUP BY
a.clp2
ORDER BY
a.tipo, CAST(a.numero AS UNSIGNED), a.localidad
");
