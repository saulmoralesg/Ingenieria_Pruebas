...
<td><a href="Manual/Guia_de_Ayuda_2020V1.pdf"><img src="Imagenes/guia.jpg" border="0" width="37" alt="Guía de Ayuda"/></a><br><strong><label onClick="window.location.href=''">Guía de Ayuda</label></strong></td>
...
?>			
	...
	++$d; ?>
        ...
        <input type="text" name="<?php echo "esp".$d;?>" id="<?php echo "esp".$d;?>" value="<?php echo $ids[$b];?>" style="display:none">        
