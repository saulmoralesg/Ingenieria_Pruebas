...
<table align="center" border="0" height="70px" >
<tr>
...
<div align="center" style="background-color:#FFF; border:0; color:#000; font-size:14px; font-weight:bold;">  
  <table width="480" border="0" id="customers"> 
    <tr>
      ...
      <td width="404"><div align="left">El  OOAD/UMAE  ha finalizado el registro de informaci&oacute;n</div></td>
    </tr>
    
    <tr>
      <td ><img src="Imagenes/rojo.png" width="25" height="25"></td>
      <td ><div align="left">El OOAD/UMAE a&uacute;n no finaliza el registro de informaci&oacute;n</div></td>
    </tr>
  </table>
  <br>
...
?>		<tbody>
		...
		<input type="text" id="<?php echo "delegoumae".$i;?>" name="<?php echo "delegoumae".$i;?>" value="<?php echo $delegoumaes[$i];?>" style="display:none">
            ...
            <td width="210"><div align="left">
				...
				<?php if($dels[$i]=='07'){?>
				 <!-- apertura individual --> <span onClick="fdels(<?php echo $i;?>)"><!-- --><?php echo $delegoumaes[$i];?></span><!-- -->  
			<?php 	}  else {?>
			  
			 
			  
				<!-- liga para entrar a unidad <span onClick="fdels(<?php echo $i;?>)">--><?php echo $delegoumaes[$i];?><!--</span>-->
