...
{	
	$pdf->SetXY(20,60);
	$pdf->MultiCell(246,4,utf8_decode('"La '.$uno.' no reporta intervenciones Excedentes/Faltantes para el año 2021"'), 0, "C",0,0,0,0);
}
else if($um>1)
{
	if($umconr>1)
...
");	
	...
	{		
		...
		$nc=max($nb,$pdf->NbLines($pdf->widths[3],$row["producto"]));
	...
	if($a<$nregistros)
	{
		if($pdf->GetY()>175) //estaba 178 //el 09sep20 estaba en 183
		$pdf->AddPage();
