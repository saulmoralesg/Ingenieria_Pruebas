...
{	
	...
	$this->Image('imagenes/dpm.jpg',23,12,100);		
...
function Footer()
{
	...
	if($this->version=='Preliminar')
	{
		...
		$this->SetX(20);
		$this->MultiCell(246,3,utf8_decode(''.$this->uno.' aún no cierra el registro de información.'), 0, "C",0,0,0,0);
		/*
				$this->SetY(-28);
		$this->SetFont('Arial','B',8);
		$this->SetX(20);
	...
	else
	{
		...
		$this->SetFont('Arial','',8);
		if($del>'41')	
		$this->Cell(72,5,'Autoriza Dir.UMAE:','1','1','C');
		else
		$this->Cell(72,5,'Autoriza TOOAD:','1','1','C');
		
		$this->SetX(50);
		$this->Cell(72,5,''.$this->namedelegado.'',1,0,'C');
	
		if($del<'41')
		{
		$this->SetXY(159,-24); //-28
		$this->Cell(70,5,utf8_decode('Autoriza Jefe de Servicios de Prestaciones Médicas: '),'1',1,'C');
		$this->SetX(159);
		$this->Cell(70,5,''.$this->namejpm.'',1,0,'C');	
		}
		else
		{
		$this->SetXY(159,-24); //-28
		$this->Cell(70,5,utf8_decode('Autoriza Director Médico: '),'1',1,'C');
		$this->SetX(159);
		$this->Cell(70,5,''.$this->namejpm.'',1,0,'C');				
		}
	}	
