...
if($cerrado==1)
{
echo "<br><label style='color:red'>REGISTRO DE INFORMACIÓN CERRADO.</label> <br>Si requiere apertura, solicitelo al ".$enlace." para el Intercambio de Servicios.
";
}
?>
</div>
...
<div align="center" style="background-color:#FFF; border:0; color:#000; font-size:14px; font-weight:bold">
  <?php 
  if(is_numeric($del))
  {echo "Paso 2.- ¿Alguna de las Unidades Médicas ".$p.$entidad." ".$delegoumae." tiene Excedentes/Faltantes de algún Servicio Médico Institucional?";}
  else
  {echo "Paso 2.- ¿El ".$entidad." ".$delegoumae." tiene Excedentes/Faltantes de algún Servicio Médico Institucional?";}
...
es necesario ingresar la contraseña ".$p.$entidad.$opcion2." y dar clic izquierdo en el botón Acceder.";
else if($opcion=="NO")
echo "Nota: para concluir el registro es necesario ingresar la contraseña ".$p.$entidad.$opcion2." y dar clic izquierdo en el botón Guardar.";
?>
...
<table width="345" border="1" id="customers">
	...
	if($opcion=="SI")
	{?>
	<input type="submit" name="save" id="save" value="Acceder">
    <?php } 
	else if($opcion=="NO")
	{?>
