...
function Header()
{	
	$this->Image('imagenes/pmx.jpg',50,13,52);		
...
function Footer()
{
	...
	else
	{
		...
		$this->SetFont('Arial','',8);
		if($del>'41')	
		$this->Cell(72,5,'Director de la Unidad :','1','1','C');
		else
		$this->Cell(72,5,'Director de la Unidad :','1','1','C');
		...
		$this->Cell(75,5,utf8_decode('Gerente de Servicios  Médicos'),'1',1,'C');
		$this->SetX(159);
		...
		{
		$this->SetXY(159,-24); //-28
		$this->Cell(70,5,utf8_decode('Gerente de Servicios  Médicos'),'1',1,'C');
		$this->SetX(159);
