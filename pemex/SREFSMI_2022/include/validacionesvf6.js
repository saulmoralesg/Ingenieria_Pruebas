...
function gregistro()
{
	...
	for(i=1; i<=nregistros; i++)
	{
		...
		if((faltantea!="" || faltanteh!="") && (causasxfila==-1 || pacientesxfila==0))
		{
			++filassindatos;
			txt += "" + i+", ";
		}
		else if((excedentea!="" || excedenteh!="") && (pacientesxfila==0))
		{
			++filassindatos;
			txt += "" + i+", ";
		}
	...
	/*se quitó el10marzo2021 02:12 am
	if(sumaexcyfalt==0)
	{
...
function ums(i)
{
    ...
    form.setAttribute("action", "grupoyespecialidad.php");
...
function xyz(i,d)
{
	...
	var ns=document.getElementById("nom_sec").value;
	var ni=document.getElementById("nom_imss").value;
	var s=document.getElementById("servicio"+i).value; 
	var g=document.getElementById("grupo"+d).value;
    ...
    form.setAttribute("action", php);
	var params = {del:dd, delegoumae:dl, clp:c, clues:cls,  nom_sec:ns, nom_imss:ni, servicio:s, grupo:g, opcion:"SI"};
    for(var key in params) {
    if(params.hasOwnProperty(key)) 
	{
            var hiddenField = document.createElement("input");
...
function xyz2(i,d)
{
	...
	var g=document.getElementById("grupo"+i).value;
	var e=document.getElementById("especialidad"+d).value;
    ...
    form.setAttribute("action", php);
	var params = {del:dd, delegoumae:dl, clp:c, clues:cls,  nom_sec:ns, nom_imss:ni, servicio: s, grupo:g, especialidad:e, opcion:"SI"};
    for(var key in params) {
    if(params.hasOwnProperty(key)) 
	{
            var hiddenField = document.createElement("input");
