...
<td><a href="Manual/Guia_ayuda_2021_pmx_2022_2022.pdf"><img src="Imagenes/guia.jpg" border="0" width="37" alt="Guía de Ayuda"/></a><br><strong><label onClick="">Guía de Ayuda</label></strong></td>
...
b.pacientes
FROM
cat_id_sec_pmx_2022  a LEFT JOIN requerimiento_pmx_2022  b ON a.producto=b.producto AND clp='$clp'
WHERE
/*gpo_serv='$grupo'*/
gpo_serv='$grupo' AND
