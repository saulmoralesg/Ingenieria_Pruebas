...
if (isset($_POST['del'])) 
{
	...
	$LoginRS__query=sprintf("SELECT del, pwd13 FROM delegaciones_ss  WHERE del=%s AND pwd13=%s",
...
b.umconr
FROM
	cat_clues_ss  a LEFT JOIN vdelygrupo b ON a.del=b.del
WHERE
	a.del = '$del'");
...
else
{
	...
	$opcion2="Instituto";
	$entidad="";
	$representante="CCINSHAE";
	
	//$opcion2="UMAE";	
	
	if($um<2)
	$txt="Una vez que el ".$delegoumae." haya registrado sus Excedentes y/o Faltantes, <br> debe imprimir el reporte pdf (versión final) para su firma por los representantes de la ".$representante.".<br><br>Para obtenerlo es necesario finalizar el registro.";	
	else
	$txt="Una vez que las Unidades Médicas de la ".$opcion2." hayan registrado sus Excedentes y/o Faltantes, <br>se debe imprimir el reporte pdf (versión final) para su firma por los representantes de la ".$representante.". 
	<br><br>Para obtenerlo es necesario finalizar el registro.";	
}
?>
...
<br><br>
<u>Paso 7.- Finalizar el registro de Excedentes y Faltantes <?php if($entidad!="Entidad Federativa") echo " del ".$opcion2; else echo "de la ".$entidad;?></u>
...
if($umconr<$um)
{
	...
	{
		if($entidad!="Entidad Federativa") echo " El ".$opcion2." no registró Excedentes/Faltantes.<br><br>¿Está seguro de cerrar el registro de información?<br>"; else echo "de la ".$entidad;	
	}
}
if($entidad=="Entidad Federativa")
echo "En caso afirmativo ingrese la contraseña de la ".$entidad." y de clic izquierdo en el botón Guardar.";
else 
echo "En caso afirmativo ingrese la contraseña del ".$opcion2." y de clic en el botón Guardar.";
?>
