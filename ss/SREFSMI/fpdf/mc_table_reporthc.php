...
$this->Cell(160,5,'HOJA DE CONSUMO DE MATERIAL DE OSTEOSÍNTESIS',0,1,'C');
...
$this->SetFont('Arial','',10);
$this->Cell(30,5,'Fecha de Cirugía','LRT',0,'C');
...
//$tres='Jefe de Conservación y Servicios Generales';
   ...
   /*1*/
    ...
    $this->Cell(50,5,'Médico Cirujano :','1',1,'C');
	$this->SetX(30);
    ...
    $this->Cell(50,5,'Médico Instrumentista :','1',1,'C');
	$this->SetX(110);
