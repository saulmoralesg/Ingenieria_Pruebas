...
$pdf->SetY(32);
$pdf->SetX(20);
$pdf->MultiCell(246,4,utf8_decode("Recolección de Excedentes y Faltantes de Servicios Médicos Institucionales para el 2021"), 0, "C",0,0,0,0);
$pdf->Ln(5);
$pdf->SetX(20);
...
{	
	$pdf->SetXY(20,60);
	$pdf->MultiCell(0,4,'"'.$uno.' no reporta intervenciones Excedentes/Faltantes para el '.utf8_decode('año').' 2021"', 0, "C",0,0,0,0);
}
else if($um>1)
{
	if($umconr>1)
