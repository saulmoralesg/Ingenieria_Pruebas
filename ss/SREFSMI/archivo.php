...
<td><a href="Manual/Guia_ayuda_2021_ss_2022.pdf"><img src="Imagenes/guia.jpg" border="0" width="37" alt="Guía de Ayuda"/></a><br><strong>Gu&iacute;a de Ayuda</strong></td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <div align="center">             
			  ...
			  {
				  ?>
                  <a href="files/<?php echo $row[1];?>"><br><img src="Imagenes/pdf.jpeg"><br>Consultar PDF subido <?php //echo $row[2];?></a>			  
				  <?php } ?>
			  </p><br>
            </div>			
			</td>			
