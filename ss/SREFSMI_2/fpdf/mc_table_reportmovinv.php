...
resumen_imptotalxprov.Proveedor,
resumen_imptotalxprov.Razon_soc,
Format(resumen_imptotalxprov.DispTotAlmacen,0) as DispTotAlmacen,
Format(resumen_imptotalxprov.DispTotCeye,0) as DispTotCeye,
Format(resumen_imptotalxprov.DisponibleTotal,0) as DisponibleTotal
FROM
resumen_imptotalxprov
WHERE
resumen_imptotalxprov.Proveedor = '.$NumProv.'
'); 
...
$this->Cell(160,5,'DETALLE DEL INVENTARIO POR PROVEEDOR',0,1,'C');
...
$this->Cell(35,5,'Importe en Almacen','LRT',0,'C');
$this->Cell(35,5,'Importe en CEYE','LRT',0,'C');
...
$this->SetX(60);
$this->SetFont('Arial','',10);
$this->Cell(80,5,''.$rowHC["Razon_soc"].'',1,0,'C');
$this->Cell(35,5,''.$rowHC["DispTotAlmacen"].'',1,0,'C');
$this->Cell(35,5,''.$rowHC["DispTotCeye"].'',1,0,'C');
$this->Cell(35,5,''.$rowHC["DisponibleTotal"].'',1,1,'C');
...
$this->Row(array('Num','Clave','Descripcion','Disponible Almacen','Disponible CEYE','Disponible TOTAL','Precio S/IVA','Importe de Disponibles','Estado'));		
...
//$tres='Jefe de Conservación y Servicios Generales';
   ...
   /*1*/
    ...
    $this->Cell(50,5,'Jefe de Oficina :','1',1,'C');
	$this->SetX(190);
