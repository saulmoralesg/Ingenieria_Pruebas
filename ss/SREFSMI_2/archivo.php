...
FROM	
cat_clues_ss a 
LEFT JOIN pdf b ON	a.del = b.del
WHERE
a.del='$del'
LIMIT 1 ");
...
<u>Paso 9.- Subir Reporte “Versión Final” firmado</u><br><br>
</div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <div align="center">             
			  ...
			  {
				  ?>
                  <a href="files/<?php echo $row[1];?>"><br><img src="Imagenes/pdf.jpeg"><br>Consultar PDF subido el <?php echo $row[2];?></a>			  
				  <?php } ?>
			  </p><br>
            </div>			
			</td>			
	  ...
	  <div align="left" style="color:#FF0000">Solo se aceptan archivos pdf con un peso máximo de 150 Megabytes.</div>
      <br>      
      </div>
</td>    
  </tr>
...
<td style="background-color:#FFF; border:0; color:#000; font-size:18px" align="center">
          ...
          <div id="etiquetaguardar" class="CampoOculto">Espere un momento, se está guardando el archivo PDF. <br>Mientras más grande sea el archivo, el tiempo de espera será mayor.</div>
        </td>
    </tr>
</table>
</form>
