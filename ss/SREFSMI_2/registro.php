...
<?php echo "Unidad Médica: ".$nom_sec;?><br><br>
...
b.pacientes
FROM
cat_id_sec a LEFT JOIN requerimiento b ON a.producto=b.producto AND clp='$clp'
WHERE
/*gpo_serv='$grupo'*/
gpo_serv='$grupo' AND
...
<strong>Nota 2: </strong> para mayor información, contacte a : ______________________________________.<br>
<strong>Nota 3: </strong> en caso de asesoría técnico - informática, contacte a la Mta. Ana Gabriela Pérez Reynaud, a la Mta. Vanessa Elizabeth L&oacute;pez Gonz&aacute;lez, al Ing. Marco Fernando Andrade Cedillo o al Ing. Acnover Calderón Pedraza. </div>
	</td>
	</tr>
	<div id="contenido">
	<tr>
