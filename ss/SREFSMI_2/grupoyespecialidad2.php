...
faltanteh
FROM
cat_id_sec a LEFT JOIN vgrupoyespecialidadvf b ON a.esp_tron_o_serv=b.esp_tron_o_serv AND b.clp='$clp' 
WHERE
gpo_serv='$grupo'
GROUP BY 
a.esp_tron_o_serv
...
FROM
requerimiento_ss a LEFT JOIN cat_id_sec b ON a.producto=b.producto
WHERE
clp='$clp' AND
a.grupo='$grupo'
GROUP BY
