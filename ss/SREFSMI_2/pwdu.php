...
<center>
<?php
$datos=mysql_query("SELECT delegoumae, tipo, numero, localidad FROM cat_clues_ss WHERE del='$del'");
...
<br />
  ...
  <div align="center" style="background-color:#FFF; border:0; color:#000; font-size:14px; font-weight:bold">Ingresar la contraseña <?php if($entidad=="") echo "la UMAE"; else echo "del ".$entidad;?>,<br>
