...
function Header()
{	
	$this->Image('imagenes/ssalogo.jpg',50,13,52);		
...
function Footer()
{
	...
	else
	{
		...
		$this->SetFont('Arial','',8);
		if($del>'41')	
		$this->Cell(72,5,'Autoriza Titular de la CCINSHAE','1','1','C');
		else
		$this->Cell(72,5,'Autoriza Secretario de Salud Estatal:','1','1','C');
		...
		$this->Cell(75,5,utf8_decode('Autoriza Enlace Estatal para el intercambio de Servicios. '),'1',1,'C');
		$this->SetX(159);
		...
		{
		$this->SetXY(159,-24); //-28
		$this->Cell(70,5,utf8_decode('Autoriza: Director General de H.R.A.E. '),'1',1,'C');
		$this->SetX(159);
